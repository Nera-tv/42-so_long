...
int mlx_string_put(void *mlx_ptr, void *win_ptr, int x, int y, int color, char *string, int size)
{
  ...
  dest_w = (FONT_WIDTH * size);   /// ratio with X11 standard mlx_string_put
  dest_h = (font_atlas.height * size);
  //dest_w = FONT_WIDTH;
